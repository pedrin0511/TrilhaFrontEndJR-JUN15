...
const observar = new IntersectionObserver((obs) => {
    obs.forEach((entrada) => {
...
function gerarMensagem() {
  ...
  mensagem = `Olá Pedro , Gostei do seu site!`;

  const phoneNumber = "5554981124330"; 
  const whatsappUrl = `https://wa.me/${phoneNumber}?text=${mensagem}`;

  window.open(whatsappUrl, '_blank');
}
/*FIM GERAR MENSAGEM NO WHATSAPP */


/* CODIGO PEGO NO https://micku7zu.github.io/vanilla-tilt.js/ PARA MOVIMENTAÇÃO DOS CARDS*/
